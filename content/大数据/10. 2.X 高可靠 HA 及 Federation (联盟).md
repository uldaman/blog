...
## 配置 Federation
还实操过, 需要的时候参考: [Hadoop 2.0 NameNode HA 和 Federation 实践](http://www.infoq.com/cn/articles/hadoop-2-0-namenode-ha-federation-practice-zh) (为防止链接失效, 我摘到了 **OneNote** 中: 我的笔记本/Hadoop 拾遗/Hadoop 2.0 NameNode HA 和 Federation 实践)
